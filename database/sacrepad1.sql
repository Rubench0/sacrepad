...
CREATE TABLE IF NOT EXISTS `sacrepad`.`subject` (
  ...
  `n_classification_subject_id` INT NOT NULL,
  `n_types_subject_id` INT NOT NULL,
  ...
  INDEX `fk_subject_cohort1_idx` (`cohort_id` ASC),
...
CREATE TABLE IF NOT EXISTS `sacrepad`.`qualification` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `inscription_id` INT NULL DEFAULT NULL,
  `create_time` DATETIME NULL,
  `update_time` DATETIME NULL,
  `user_id` INT NULL DEFAULT NULL,
  `subject_id` INT NULL DEFAULT NULL,
