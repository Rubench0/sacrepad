 ...
 */
final class Version20190320024117 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE binnacle_access_user CHANGE user_id user_id INT DEFAULT NULL, CHANGE system system VARCHAR(45) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE binnacle_access_user CHANGE user_id user_id INT NOT NULL, CHANGE system system VARCHAR(3000) DEFAULT NULL COLLATE utf8_general_ci');
